...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ideaAboutProject: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blogProfileSection: Schema.Attribute.Component<'shared.profile', true>;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    caseStudyContents: Schema.Attribute.DynamicZone<
      [
        'blog-and-casestudies.sepration',
        'blog-and-casestudies.code-section',
        'blog-and-casestudies.blog-or-casestudy-text',
    ...
    profile: Schema.Attribute.Component<
      'blog-and-casestudies.company-profile',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    case_studies_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::case-study.case-study'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<
      'contact-us.contact-us-bottom-cards',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'footer.footer-links', false>;
    legal: Schema.Attribute.Component<'footer.footer-legal-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactSection: Schema.Attribute.Component<
      'homepage.homepage-contact-and-testimonials',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fifthSection: Schema.Attribute.Component<
      'homepage.homepage-fifth-section',
      false
    >;
    fourthSection: Schema.Attribute.Component<
      'homepage.homepage-fourth-section',
      false
    >;
    heroSection: Schema.Attribute.Component<
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    navbarLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    navButton: Schema.Attribute.Component<'elements.buttons', true>;
    navLevelOneGroup: Schema.Attribute.Component<
      'navbar.navbar-level1-group',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    heading: Schema.Attribute.String;
    legalDescription: Schema.Attribute.DynamicZone<['legal.details']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    userStatus: Schema.Attribute.Enumeration<
      ['active', 'inactive', 'cancelled', 'paused', 'expired']
    >;
  };
}
